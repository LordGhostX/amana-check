...
- Ingestion runs through the production cron route every three hours using eight Hobby-compatible entries; local runs remain available through `bun run ingest`.
